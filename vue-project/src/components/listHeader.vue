<template>
  <div style="padding:20px">
    <el-card shadow="never" class="box-card">
      ...
      <el-form :inline="true" :model="formInline" class="demo-form-inline" style="margin-top:15px">
    ...
    <el-select v-model="value" placeholder="批量操作" style="margin-top:20px" size="small">
      <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value"></el-option>
    </el-select>
    <el-button @click="change" type="primary" size="small" style="margin-left:20px;">确定</el-button>
    <el-pagination
